...
struct lfg_logger_state {
    ggml_log_callback log_callback = lfg_log_callback_default;
...
void lfg_log_get(ggml_log_callback * log_callback, void ** user_data) {
    ggml_log_get(log_callback, user_data);
}

void lfg_log_set(ggml_log_callback log_callback, void * user_data) {
    ggml_log_set(log_callback, user_data);
    g_logger_state.log_callback = log_callback ? log_callback : lfg_log_callback_default;
    g_logger_state.log_callback_user_data = user_data;
}

static void lfg_log_internal_v(ggml_log_level level, const char * format, va_list args) {
    va_list args_copy;
...
void lfg_log_internal(ggml_log_level level, const char * format, ...) {
    ...
    lfg_log_internal_v(level, format, args);
    va_end(args);
}
