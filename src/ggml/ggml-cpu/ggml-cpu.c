...
#undef GGML_USE_LIQUIDFILE
#endif

#ifdef GGML_USE_LIQUIDFILE
#include "liquidfile/sgemm.h"
#endif
...
UseGgmlGemm2:;
    ...
    //   Also, chunking by thread was measured to have perform better on NUMA systems.  See https://github.com/ggml-org/liquid.cpp/pull/6915
...
int ggml_cpu_has_liquidfile(void) {
#if defined(GGML_USE_LIQUIDFILE)
    return 1;
#else
    return 0;
#endif
