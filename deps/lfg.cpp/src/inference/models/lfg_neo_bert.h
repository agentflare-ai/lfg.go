...
struct lfg_build_neo_bert : public lfg_graph_context {
    const lfg_model & model;

    inline lfg_build_neo_bert(const lfg_model & model, const lfg_graph_params & params) :
